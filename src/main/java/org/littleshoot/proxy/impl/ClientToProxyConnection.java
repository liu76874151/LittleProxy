...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
     ...
     * 
     * <p>
     * If authentication is still required, either because no credentials were provided or the credentials were wrong,
     * this writes a 407 response to the client.
     * </p>
     * 
     * @param request
     * @return
     ...
     * will not be disconnected, unless the response includes a "Connection: close" header, or the filter returns a null
